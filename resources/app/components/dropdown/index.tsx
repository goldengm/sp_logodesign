...
const Dropdown = (props: {
  ...
  useOutsideAlerter(wrapperRef, (open: boolean) => {
    setOpenWrapper(open);
    if (onClosed != null) onClosed(open);
  });

  useEffect(() => {
    if (childOpenWrapper != null) setOpenWrapper(childOpenWrapper);
  }, [childOpenWrapper]);
